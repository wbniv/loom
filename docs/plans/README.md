...
| Date | Plan | Status |
|---|---|---|
| 2026-08-24 | [Corpus-size sweep: does acceptance track definition count, or content?](2026-08-24-corpus-size-sweep.md) | Pre-registered; nested 8/15/25/41-def stores built and stub-verified, GPU runs pending |
